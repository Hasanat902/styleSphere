    ...
    <div className="mt-32">
      <div className="max-w-7xl mx-auto my-10 p-4">
        {getTotalCartItems() === 0 ? (
          ...
          <div>
            <div className="grid grid-cols-2 sm:grid-cols-6 md:grid-cols-[0.5fr, 2fr, 1fr, 1fr, 1fr, 1fr] items-center px-4">
              <p>Products</p>
              <p>Title</p>
            ...
            {all_product.map((p) => {
              if (cartItems[p.id] > 0) {
                return (
                  <div key={p.id}>
                    <div className="text-gray-500 font-semibold text-sm sm:text-base grid grid-cols-2 sm:grid-cols-6 md:grid-cols-[0.5fr, 2fr, 1fr, 1fr, 1fr, 1fr] items-center px-4 gap-2">
                      <img
                        src={p.image}
                        alt="product"
                      ...
                      />
                      <p>{p.name}</p>
                      <p className="hidden md:block">${p.new_price}</p>
