    ...
    <div className="grid grid-cols-1 md:grid-cols-2 my-20 md:gap-10 px-6 md:px-0">
      ...
      <div className="flex md:1/2 flex-col mt-8 md:mt-0">
        ...
        <p className="text-gray-500">
          ...
          voluptates dolorem maxime ad alias ex commodi quam officia unde, non
          assumenda animi? Officiis eius itaque recusandae necessitatibus quasi
          corporis sequi?
        </p>
        <div>
        ...
        <p>
          <span className="font-semibold">Category: </span>Women, T-shirt, Tops
        </p>
        <p>
